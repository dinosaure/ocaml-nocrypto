...
module AES :
  sig
    external enc :
      buffer -> off -> buffer -> off -> key -> int -> size -> unit
      = "caml_nc_aes_enc_bc" "caml_nc_aes_enc" [@@noalloc]
    external dec :
      buffer -> off -> buffer -> off -> key -> int -> size -> unit
      = "caml_nc_aes_dec_bc" "caml_nc_aes_dec" [@@noalloc]
    external derive_e : secret -> off -> key -> int -> unit
      = "caml_nc_aes_derive_e_key" [@@noalloc]
    external derive_d : secret -> off -> key -> int -> key option -> unit
      = "caml_nc_aes_derive_d_key" [@@noalloc]
...
module DES :
  sig
    external ddes : buffer -> off -> buffer -> off -> int -> unit
      = "caml_nc_des_ddes" [@@noalloc]
    external des3key : secret -> off -> int -> unit = "caml_nc_des_des3key"
      [@@noalloc]
...
module MD5 :
  sig
    ...
    external update : ctx -> buffer -> off -> size -> unit
      = "caml_nc_md5_update" [@@noalloc]
    external finalize : ctx -> buffer -> off -> unit = "caml_nc_md5_finalize"
      [@@noalloc]
...
module SHA1 :
  sig
    ...
    external update : ctx -> buffer -> off -> size -> unit
      = "caml_nc_sha1_update" [@@noalloc]
    external finalize : ctx -> buffer -> off -> unit
      = "caml_nc_sha1_finalize" [@@noalloc]
...
module SHA224 :
  sig
    ...
    external update : ctx -> buffer -> off -> size -> unit
      = "caml_nc_sha224_update" [@@noalloc]
    external finalize : ctx -> buffer -> off -> unit
      = "caml_nc_sha224_finalize" [@@noalloc]
...
module SHA256 :
  sig
    ...
    external update : ctx -> buffer -> off -> size -> unit
      = "caml_nc_sha256_update" [@@noalloc]
    external finalize : ctx -> buffer -> off -> unit
      = "caml_nc_sha256_finalize" [@@noalloc]
...
module SHA384 :
  sig
    ...
    external update : ctx -> buffer -> off -> size -> unit
      = "caml_nc_sha384_update" [@@noalloc]
    external finalize : ctx -> buffer -> off -> unit
      = "caml_nc_sha384_finalize" [@@noalloc]
...
module SHA512 :
  sig
    ...
    external update : ctx -> buffer -> off -> size -> unit
      = "caml_nc_sha512_update" [@@noalloc]
    external finalize : ctx -> buffer -> off -> unit
      = "caml_nc_sha512_finalize" [@@noalloc]
